...
const Hero = () => {
  return (
    <section>
      <div className='w-full bg-[url("/assets/herobg.webp")] sm:pr-56 pr-20  bg-cover bg-center lg:min-h-270 md:min-h-240 sm:min-h-210 min-h-155 max-w-[1920px] mx-auto lg:pt-64 md:pt-58 sm:pt-50 pt-40'>
        <div className='max-w-237.5 lg:py-20 lg:pl-20 lg:pr-24.5 md:py-15 md:pl-15 md:pr-19 sm:py-10 sm:px-10 py-8 px-8   bg-dark-charcol '>
          <div className='max-w-193 '>
            <img className=' md:w-[273.41px] sm:w-50 w-40  md:h-20 sm:h-18 h-14  xl:mb-10 lg:mb-8 md:mb-6 mb-4' src="/assets/navlogo.webp" alt="hero-logo" />
